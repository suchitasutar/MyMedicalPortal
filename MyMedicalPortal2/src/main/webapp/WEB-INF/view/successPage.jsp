...
<body>
	...
	<div class="row">
		...
		<% if(l.getRole().equals("patient")){ %>
					<form action="searchPatientById.html" method="post" name ="personal" >
					 	<input type="hidden" class="form-control" id="exampleInputEmail1" name="id" value=<%= "P1"+l.getId() %>>
		...
		<% if(l== null){ %>
	      ...
	      <!-- display window -->
			<div class="main"><br/><br/><br/><br/><br/><br/><br/><br/>
				<h1><div style="text-align:center;">
				Dear <span style="color: orange;"> Patient </span> <br/>
				 Your Appointment has successfully registered.
				 <br/>
				 Use Following Login Details:<br/>
				 UserName: Your Email Address </br>
				 Password: Your Aadhar Number</br>
